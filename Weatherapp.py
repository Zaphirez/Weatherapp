...
# Function for getting individual Pieces of the input so it doesnt matter which way you input the Country Code and Name
def separate_letters_and_numbers(lst):
    ...
    for i in lst:
        if i.isnumeric():
            ...
            # If there are Letters in the Country Code or Numbers in the Country Name
            return 'Wrong Format'
...
wind_s = math.ceil(int(data_w['wind']['speed']) * 1.852)  # Rounding the Numbers also Converting it to km/h del if you want miles
